...
export default function Step1 ({ setCurrStep, setProfessorValues }) {
    ...
    const onSubmit = (data) => {
        setCurrStep(2)
        setProfessorValues(prev => ({...prev, data}))
    }
    ...
    return (
        <Form className='center' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='btnContainer'>
                <ButtonAlt type="button" onClick={() => navigate('/diretor/professores')}>Voltar</ButtonAlt>
